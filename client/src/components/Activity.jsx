...
const Activity = () => {
    ...
    const getAllActivitie =async()=>{
        try{
            const res = await axios.get("https://healthandhygeinebackend-huew.onrender.com/api/v1/activity/all-activity");
    ...
    const handleDelete = (rid) => {
        axios.delete(`https://healthandhygeinebackend-huew.onrender.com/api/v1/activity/activity-register/delete/${rid}`)
          .then((response) => {
            getAllActivitie();
